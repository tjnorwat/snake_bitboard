...
struct Game {
    ...
    pair<uint64_t, uint64_t> update_food(Player &player, pair<uint64_t, uint64_t> food_board) {
    ...
    int minimax(Player &me, Player &opponent, pair<uint64_t, uint64_t> &food_board, int depth, int alpha, int beta, int &nodes_visited) {
        ...
        for (const uint16_t& my_move : my_move_board) {
            ...
            pair<uint64_t, uint64_t> my_food_board = update_food(temp_me, food_board);
            ...
            for (const uint16_t& opponent_move : opponent_move_board) {
                ...
                pair<uint64_t, uint64_t> opponent_food_board = update_food(temp_opponent, food_board);
    ...
    void print_board(Player me, Player opponent, pair<uint64_t, uint64_t> food_board) const {
